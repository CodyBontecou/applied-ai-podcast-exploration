...
# input_audio = AudioFileClip(f'split_17_output-{file_number}.wav')
...
def process_video(wordlevel_info_modified, file_number):
    def split_text_into_lines(data):  
    ...
    input_audio = AudioFileClip(f's split_17_output-{file_number}.wav')
    input_audio_duration = input_audio.duration
